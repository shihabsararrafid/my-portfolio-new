...
const About = ({ open, setOpen }) => {
  return (
    <div className="bg-[#1D1D1D] px-10 w-full min-h-screen lg:w-[90%]">
      ...
      <h1
        className="text-[#08fdd8]   text-6xl my-10 font-bold font-mono"
        data-aos="fade-up"
      ...
      <div className="overView">
        <h1
          className="text-[#08fdd8]   border-white text-3xl font-semibold "
          data-aos="fade-up"
          data-aos-easing="linear"
          data-aos-duration="1500"
        >
        ...
        <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
          <p
            className="text-white px-1 lg:px-5 text-justify py-5 text-2xl"
            data-aos="fade-left"
            data-aos-easing="linear"
            data-aos-duration="1500"
          >
          ...
          <div class="avatar">
            <div
              class="lg:w-[90%] w-full py-5 rounded-2xl"
              data-aos="fade-right"
              data-aos-easing="linear"
              data-aos-duration="1500"
            >
